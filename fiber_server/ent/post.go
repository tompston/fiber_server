...
type Post struct {
	...
	// PostTitle holds the value of the "post_title" field.
	PostTitle string `json:"post_title,omitempty"`
	// PostBody holds the value of the "post_body" field.
...
func (*Post) scanValues(columns []string) ([]interface{}, error) {
	...
	for i := range columns {
		...
		case post.FieldPostTitle, post.FieldPostBody:
	...
	for i := range columns {
		...
		case post.FieldPostTitle:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field post_title", values[i])
			} else if value.Valid {
				po.PostTitle = value.String
			}
		case post.FieldPostBody:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field post_body", values[i])
			} else if value.Valid {
				po.PostBody = value.String
			}
		case post.FieldCreatedAt:
...
func (po *Post) String() string {
	...
	builder.WriteString(", post_title=")
	builder.WriteString(po.PostTitle)
	builder.WriteString(", post_body=")
	builder.WriteString(po.PostBody)
